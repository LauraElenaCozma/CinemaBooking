...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/bookings/delete/**").hasAnyRole("CUSTOMER","ADMIN")
                .antMatchers("/bookings/update/**").hasAnyRole("CUSTOMER","ADMIN")
                .antMatchers("/bookings/new").hasRole("CUSTOMER")
                .antMatchers("/bookings/myBookings").hasRole("CUSTOMER")
                .antMatchers("/users/**").hasAnyRole("CUSTOMER", "ADMIN")
//                .antMatchers("/users/myProfile").hasRole("CUSTOMER")
//                .antMatchers("/users/delete/**").hasRole("CUSTOMER")
//                .antMatchers("/users/update/**").hasRole("CUSTOMER")
